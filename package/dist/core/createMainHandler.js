...
import { resolveConverter, resolveIncrementalCache, resolveQueue, resolveTagCache, resolveWrapper, } from "./resolve";
export async function createMainHandler() {
    //First we load the config
    const config = await import(process.cwd() + "/open-next.config.mjs").then((m) => m.default);
