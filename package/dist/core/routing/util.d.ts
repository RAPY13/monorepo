 ...
 * @__PURE__
 */
export declare function proxyRequest(internalEvent: InternalEvent, res: OpenNextNodeResponse): Promise<void>;
declare global {
 ...
 * @__PURE__
 */
export declare function fixCacheHeaderForHtmlPages(rawPath: string, headers: OutgoingHttpHeaders): void;
/**
 *
 * @__PURE__
 */
 ...
 * @__PURE__
 */
export declare function createServerResponse(internalEvent: InternalEvent, headers: Record<string, string | string[] | undefined>, responseStream?: StreamCreator): OpenNextNodeResponse;
