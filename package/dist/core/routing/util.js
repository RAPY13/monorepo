...
import { BuildId, HtmlPages } from "../../adapters/config/index.js";
 ...
 * @__PURE__
 */
export async function proxyRequest(internalEvent, res) {
    ...
    await new Promise((resolve, reject) => {
        ...
        const req = request(url, {
            ...
            res.writeHead(_res.statusCode ?? 200, filterHeadersForProxy(_res.headers));
 ...
 * @__PURE__
 */
export function fixCacheHeaderForHtmlPages(rawPath, headers) {
...
export function generateMessageGroupId(rawPath) {
    ...
    const maxConcurrency = parseInt(process.env.MAX_REVALIDATE_CONCURRENCY ?? "10");
 ...
 * @__PURE__
 */
export function createServerResponse(internalEvent, headers, responseStream) {
