...
import { convertRes, convertToQuery, convertToQueryString, createServerResponse, proxyRequest, } from "../core/routing/util";
...
async function convertToCloudFrontRequestResult(result, originalRequest) {
    let responseHeaders = result.type === "middleware"
    ...
    if (result.type === "middleware") {
        ...
        if (result.isExternalRewrite) {
            ...
            const body = await fromReadableStream(externalResult.body, externalResult.isBase64Encoded);
