...
export function compileOpenNextConfigNode(tempDir, openNextConfigPath, nodeExternals) {
...
export function compileOpenNextConfigEdge(tempDir, config, openNextConfigPath) {
    const sourcePath = path.join(process.cwd(), openNextConfigPath ?? "open-next.config.ts");
